<section  class="sky-form">
              ...
              <section  class="sky-form">
                    <h4>Filtrar por calidad</h4>
                    <div class="row1 row4 scroll-pane">
                      <div class="col col-4">
                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>1 estrella</label>
                      </div>
                      <div class="col col-4">
                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>2 estrellas</label>
                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>3 estrellas</label>
                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>4 estrellas</label>
                        <label class="checkbox"><input type="checkbox" name="checkbox"><i></i>5 estrellas</label>
              ...
              <section class="sky-form">
                    <h4>Etiquetas de búsqueda</h4>
                      <div class="row5 scroll-pane">
                        <ul class="tags_links">
                          <li><a href="#">Cerro Colorado</a></li>
                          ...
                          <li><a href="#">Boticas</a></li>
                          <li><a href="#">Avenida 54</a></li>
                          <li><a href="#">Plaza de Armas</a></li>
                          <li><a href="#">Maderera</a></li>
